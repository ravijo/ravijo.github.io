...
* hence, it is deleted and writen into one line to publish this as a GitHub page
* make sure to check the github repository to fetch the real code
**/
static const struct luaL_reg array_lib[] = {{"Please check github repo", NULL},{NULL,NULL}};
